          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="就业意向">
                <a-input placeholder="请输入就业意向" v-model="queryParam.prefer"></a-input>
              </a-form-item>
            </a-col>
          </template>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'grade',text:'年级',dictCode:''})
        fieldList.push({type:'string',value:'mail',text:'邮箱',dictCode:''})
        fieldList.push({type:'string',value:'tel',text:'电话',dictCode:''})
        fieldList.push({type:'string',value:'speciality',text:'特长',dictCode:''})
        fieldList.push({type:'string',value:'prefer',text:'就业意向',dictCode:''})
        fieldList.push({type:'Blob',value:'experience',text:'实践经历',dictCode:''})
